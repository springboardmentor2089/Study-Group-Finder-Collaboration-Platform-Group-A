...
public class SessionService {
    ...
    public Map<String, Object> createSession(Long groupId, String creatorEmail, Map<String, Object> body) {
        ...
        if (!isMember) {
            throw new RuntimeException("You must be a member to create sessions.");
        }
        ...
        if (dateStr != null) {
            ...
            LocalDateTime sessionDate = LocalDateTime.parse(dateStr);
    ...
    public void deleteSession(Long sessionId, String userEmail) {
        ...
        boolean isCreator = session.getCreatedBy() != null &&
                session.getCreatedBy().getId().equals(user.getId());
